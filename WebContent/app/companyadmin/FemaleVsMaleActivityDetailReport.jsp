...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
	<div class="row">
		<ol class="breadcrumb">
			...
			<li class="active">Reports / Female vs Male Activity</li>
		</ol>
	</div><!--/.row-->
	...
	<div class="row">
		<div class="col-lg-12">
			<div class="panel panel-default">
				<div class="panel-heading">Female vs Male Activity <a href="exportFemaleVsMaleActivityAdminReportToExcel.do?fromDate=${fromDate}&toDate=${toDate}" class="btn btn-default">Export</a></div>
				<div class="col-md-8">
					
					<form class="form-inline" name="femaleVsMaleDetail" id="femaleVsMaleDetail" action="femaleVsMaleActivityDetailAdminReport.do" method="post">
				...
				<div class="panel-body">
					<table id="femaleVsMaleDetailTable" data-search="true" data-pagination="true" data-show-refresh="false"
...
$( document ).ready(function() {
	...
	$table = $('#femaleVsMaleDetailTable').bootstrapTable({
    	data: getRows()
    });
});
...
function getReportDetail() {
	if($('#fromDate').val()!='' && $('#toDate')!=null) {
		document.getElementById('femaleVsMaleDetail').submit();
	} else {
