...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
	<div class="row">
		<ol class="breadcrumb">
			...
			<li class="active">Reports / Water By Department</li>
		</ol>
	</div><!--/.row-->
	...
	<div class="row">
		<div class="col-lg-12">
			<div class="panel panel-default">
				<div class="panel-heading">Water By Department <a href="exportWaterByDepartmentAdminReportToExcel.do?fromDate=${fromDate}&toDate=${toDate}" class="btn btn-default">Export</a></div>
				<div class="col-md-8">
					
					<form class="form-inline" name="waterByDepartmentDetail" id="waterByDepartmentDetail" action="waterByDepartmentDetailAdminReport.do" method="post">
				...
				<div class="panel-body">
					<table id="WaterByDepartmentDetailTable" data-search="true" data-pagination="true" data-show-refresh="false"
...
$( document ).ready(function() {
	...
	$table = $('#WaterByDepartmentDetailTable').bootstrapTable({
    	data: getRows()
    });
});
...
function getReportDetail() {
	if($('#fromDate').val()!='' && $('#toDate')!=null) {
		document.getElementById('waterByDepartmentDetail').submit();
	} else {
